...
from .variable_importance import VIP, sMC
...
class PLSDA(BaseEstimator):
    ...
    def calculate_VIP(self): 
        ...
        return VIP(self.x_scores, self.y_loadings, self.x_weights)
    ...
    def calculate_sMC(self, X):
        ...
        return sMC(self.coef, X, scale=self.scale)
    ...
    def fit(self, X, y, groups=None, print_results=False):
        ...
        if self.enforce_nLVs is None:
            ...
            for i in range(0, self.max_LV):
                model = PLSDA(n_components=i+1, scale=self.scale, calculate_explained_var=False)
